...
public class EmployeeKey extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 1811530474066689085L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"EmployeeKey\",\"namespace\":\"com.ms.schema\",\"fields\":[{\"name\":\"id\",\"type\":\"int\"},{\"name\":\"departmentName\",\"type\":\"string\"}]}");
   ...
   */
  public static com.ms.schema.EmployeeKey.Builder newBuilder() {
    return new com.ms.schema.EmployeeKey.Builder();
  }
   ...
   * @return A new EmployeeKey RecordBuilder
   */
  public static com.ms.schema.EmployeeKey.Builder newBuilder(com.ms.schema.EmployeeKey.Builder other) {
    if (other == null) {
      return new com.ms.schema.EmployeeKey.Builder();
    } else {
      return new com.ms.schema.EmployeeKey.Builder(other);
    }
  }
   ...
   * @return A new EmployeeKey RecordBuilder
   */
  public static com.ms.schema.EmployeeKey.Builder newBuilder(com.ms.schema.EmployeeKey other) {
    if (other == null) {
      return new com.ms.schema.EmployeeKey.Builder();
    } else {
      return new com.ms.schema.EmployeeKey.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<EmployeeKey>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.ms.schema.EmployeeKey.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.ms.schema.EmployeeKey other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ms.schema.EmployeeKey.Builder setId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ms.schema.EmployeeKey.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ms.schema.EmployeeKey.Builder setDepartmentName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ms.schema.EmployeeKey.Builder clearDepartmentName() {
      departmentName = null;
